...
('魔法少女一代-烏薩奇', '☀商品名稱：吉伊卡哇 一代-魔法少女掛件\r\n☀尺寸：約 H170 x W140 x D80mm\r\n☀材質：聚酯纖維、鐵', '10', 540, 1, '/assets/images/magic_usagi.jpg', 1),
...
CREATE TABLE `訂單` (
  ...
  `付款狀態` char(100) DEFAULT NULL,
  `下單日期` char(100) DEFAULT NULL,
...
--
ALTER TABLE `會員`
  MODIFY `會員編號` int(100) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
